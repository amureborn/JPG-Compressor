...
*/
    ...
    function createSingleDownloadLink(compressedFile) {
        ...
        downloadButton.download = `${originalFilename}_prepphint.com.jpeg`;
    }
    ...
    function createDownloadLink(compressedFiles) {
        ...
        compressedFiles.forEach((file, index) => {
            ...
            zip.file(`${originalFilename}_prepphint.com.jpeg`, file);
        });
        zip.generateAsync({ type: 'blob' }).then(function(content) {
            const url = URL.createObjectURL(content);
            downloadButton.href = url;
            downloadButton.download = 'compressed_files.zip';
        });
    }
